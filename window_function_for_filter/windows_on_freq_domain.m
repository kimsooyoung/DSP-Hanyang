...
rect_10 = rectwin(21); rect_40 = rectwin(41);
bartlett_10 = bartlett(21); bartlett_40 = bartlett(41);
hamming_10 = hamming(21); hamming_40 = hamming(41);
hann_10 = hann(21); hann_40 = hann(41);
blackman_10 = blackman(21); blackman_40 = blackman(41);
...
for j = 1:2
    figure(j+1)
    for i = 0:4
        freq_signal_10 = abs(fft(windows_10(i+1,:), fft_size(j)));
        freq_signal_40 = abs(fft(windows_40(i+1,:), fft_size(j)));
