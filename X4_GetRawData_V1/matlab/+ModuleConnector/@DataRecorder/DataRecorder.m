classdef DataRecorder
    ...
    methods
        ...
        function dr = DataRecorder(lib_name,mc)
            ...
            dr.dataRecorderInterface = ModuleConnector.DataRecorderInterface(lib_name);
            
            % Create DataRecorder instance.
            % Check mode of operation: standalone or via MC.
            if nargin < 2
                % Call create method without MC argument.
                dr.dataRecorder_instance = calllib(lib_name,'nva_create_data_recorder');
            else
                % Else, call get method with MC argument to record from module.
                dr.dataRecorder_instance = calllib(lib_name,'nva_get_data_recorder',mc.mcInstance);
            end
