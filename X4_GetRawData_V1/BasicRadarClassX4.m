classdef BasicRadarClassX4 < handle
    % BasicRadarClassX4 provides aggregated calls to ModuleConnector.
    %
    % BasicRadarClassX4 methods:
    %
    %
    %
    % See also NVA_X2_Variable, FunctionalRadarClass, ModuleConnector
    %
    % Compatible MinGW Compiler avaliable at
    % https://sourceforge.net/projects/tdm-gcc/files/TDM-GCC%20Installer/
    % Previous/1.1309.0/tdm64-gcc-4.9.2-3.exe/download
    ...
    properties (SetAccess = private,Hidden)
        ...
        default_FrameOffset_X4M03 = 0.5144; % FrameAreaOffset for X4M03 module.
        default_FrameOffset_X4M02 = 0.5144; % FrameAreaOffset for X4M02 module.
    end
